...
this.chromeChild.stdout.setEncoding('utf8');
this.chromeChild.stdout.on('data', function(data) {
    //Here is where the output goes

    console.log('stdout: ' + data);
});

this.chromeChild.stderr.setEncoding('utf8');
this.chromeChild.stderr.on('data', function(data) {
    //Here is where the error output goes

    console.log('stderr: ' + data);
});
this.chromeChild.on('close', function(code) {
